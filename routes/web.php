...
Route::add('GET', '/employees_list', [Controller\EmployeeController::class, 'employees_list'])->middleware('auth', 'admin_or_deanery');
Route::add('GET', '/departaments_list', [Controller\DepartmentController::class, 'departaments_list'])->middleware('auth', 'admin_or_deanery');
Route::add('GET', '/subjects_list', [Controller\SubjectController::class, 'subjects_list'])->middleware('auth', 'admin_or_deanery');
